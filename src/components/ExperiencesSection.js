...
const ExperienceSection = () => {
  return (
    <section id="experiences" className="bg-white min-h-screen flex flex-col items-center p-8">
        ...
        <div className="relative border-l border-gray-400 dark:border-gray-700 pl-6">
          {experiences.map((experience, index) => (
            <div key={index} className="mb-8 ml-4">
              <div className="absolute -left-3 w-6 h-6 dark:bg-gray-700 rounded-full bg-white border-4 border-indigo-500 dark:border-indigo-500"></div>
              <div className="dark:bg-slate-800 border-4 border-indigo-500 dark:bg-gray-800 shadow-md p-6 rounded-lg shadow-md">
