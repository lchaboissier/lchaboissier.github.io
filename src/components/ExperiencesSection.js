...
const ExperienceSection = () => {
  return (
    <section id="experience" className="min-h-screen flex flex-col items-center bg-gray-100 dark:bg-gray-900 p-8">
      <div className="container mx-auto">
        ...
        <div className="relative border-l border-gray-400 dark:border-gray-700 pl-6">
          {experiences.map((experience, index) => (
            <div key={index} className="mb-8 ml-4 relative">
              <div className="absolute -left-3 w-6 h-6 bg-gray-200 dark:bg-gray-700 rounded-full border border-white dark:border-gray-900"></div>
